    ...
    <div class="modal-content relative w-full max-w-md bg-white rounded-xl shadow-2xl p-6"
        ...
        <form id="rescheduleForm" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <x-datepicker name="schedule_date" id="reschedule-date" required="true" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" :min-date="now()->format('Y-m-d')" />
            </div>
