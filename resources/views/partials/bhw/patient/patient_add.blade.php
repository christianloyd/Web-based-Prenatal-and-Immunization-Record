...
<div id="patient-modal"
    ...
    <div class="modal-content relative w-full max-w-2xl bg-white rounded-xl shadow-2xl p-6 my-8"
        ...
        <!-- Form -->
        <form action="{{ route('bhw.patients.store') }}" 
            method="POST"
            id="patient-form"
            class="space-y-5"
            novalidate>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="occupation" id="add-occupation" value="{{ old('occupation') }}"
                ...
                <div>
                    ...
                    <input type="tel" name="contact" id="add-contact" value="{{ old('contact') }}"
                ...
                <div>
                    ...
                    <input type="tel" name="emergency_contact" id="add-emergency-contact" value="{{ old('emergency_contact') }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="address" id="add-address" rows="3"
