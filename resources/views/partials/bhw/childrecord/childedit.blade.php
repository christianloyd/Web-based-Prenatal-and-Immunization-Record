...
<div id="edit-child-modal"
    ...
    <div class="modal-content relative w-full max-w-4xl bg-white rounded-xl shadow-2xl p-6 my-8"
        ...
        <!-- Form -->
        <form action="{{ route('bhw.childrecord.update', ':id') }}" 
            method="POST"
            id="edit-child-form"
            data-update-url="{{ route('bhw.childrecord.update', ':id') }}"
            class="space-y-5"
            novalidate>
            @csrf
            @method('PUT')
            ...
            <!-- Check for regular validation errors as well -->
            @if ($errors->any())
                <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-4">
                    <div class="font-medium">Please correct the following errors:</div>
                    <ul class="list-disc list-inside mt-2">
                        ...
                        <div>
                            ...
                            <div class="flex space-x-6">
                                <label class="flex items-center">
                                    <input type="radio" id="edit-gender-male" name="gender" value="Male" required class="text-[#68727A] focus:ring-[#68727A]" {{ old('gender') == 'Male' ? 'checked' : '' }}>
                                    <span class="ml-2 text-gray-700">Male</span>
                                </label>
                                <label class="flex items-center">
                                    <input type="radio" id="edit-gender-female" name="gender" value="Female" required class="text-[#68727A] focus:ring-[#68727A]" {{ old('gender') == 'Female' ? 'checked' : '' }}>
            ...
            <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-3 pt-4 border-t">
                ...
                <button type="submit" id="edit-submit-btn" class="btn-minimal btn-primary-clean px-6 py-2.5 rounded-lg font-medium">
