...
<div class="space-y-2">
    <!-- Back Button -->
    <div class="mb-2">
        <a href="{{ route('bhw.childrecord.index') }}" class="btn-action btn-view inline-flex items-center">
    ...
    <div class="bg-white rounded shadow-sm border">
        ...
        <div class="px-4 py-3">
            ...
            <div class="flex justify-end space-x-1">
                <a href="{{ route('bhw.immunizations.index') }}" class="btn-action btn-success inline-flex items-center">
                    <i class="fas fa-syringe mr-1"></i>
                    <span class="hidden sm:inline">Schedule</span>
                </a>
                <a href="{{ route('bhw.childrecord.edit', $childRecord->id) }}" class="btn-action btn-edit inline-flex items-center">
                                ...
                                <div class="relative z-10 flex flex-col items-center">
                                    ...
                                    <div id="tooltip-dose-{{ $vaccineIndex }}-{{ $doseIndex }}" role="tooltip" class="absolute z-30 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip">
                                        <div class="text-center">
                                            ...
                                            <div>{{ $immunization->dose ?? ($doseIndex + 1) }}</div>
                                        </div>
                                        <div class="tooltip-arrow" data-popper-arrow></div>
                                    </div>
                                </div>
                ...
                <div class="mt-6 pt-4 border-t border-gray-100">
                    <div class="flex flex-wrap gap-4 justify-center text-xs">
                        <div class="flex items-center">
                            <div class="w-4 h-4 bg-green-100 border border-green-400 rounded-full flex items-center justify-center mr-2">
                                <i class="fas fa-check text-green-600 text-xs"></i>
                            </div>
                            <span class="text-gray-600">Completed</span>
                        </div>
                        <div class="flex items-center">
                            <div class="w-4 h-4 bg-yellow-100 border border-yellow-400 rounded-full flex items-center justify-center mr-2">
                                <i class="fas fa-clock text-yellow-600 text-xs"></i>
                            </div>
                            <span class="text-gray-600">Upcoming</span>
                        </div>
                        <div class="flex items-center">
                            <div class="w-4 h-4 bg-red-100 border border-red-400 rounded-full flex items-center justify-center mr-2">
