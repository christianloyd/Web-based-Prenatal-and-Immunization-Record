...
<link rel="stylesheet" href="{{ asset('css/bhw/prenatalrecord-index.css') }}">
@endpush
...
{{-- Include prenatal record index specific JavaScript --}}
<script src="{{ asset('js/bhw/prenatalrecord-index.js') }}"></script>
@endpush
