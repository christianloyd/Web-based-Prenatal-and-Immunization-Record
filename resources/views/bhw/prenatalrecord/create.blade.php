...
{{-- Include prenatal record create specific CSS --}}
<link rel="stylesheet" href="{{ asset('css/bhw/prenatalrecord-create.css') }}">
@endpush
...
{{-- Include prenatal record create specific JavaScript --}}
