...
<div class="space-y-6">
    ...
    <div class="bg-white p-4 rounded-lg shadow-sm border">
        <form method="GET" action="{{ route('midwife.patients.index') }}">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="flex space-x-2">
                    ...
                    <a href="{{ route('midwife.patients.index') }}" class="flex-1 bg-gray-100 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-200 transition-colors text-center">
                        Clear
                    </a>
                </div>
            </div>
...
@include('partials.midwife.patient.patient_add')

<!-- View Patient Modal -->
@include('partials.midwife.patient.patient_view')

<!-- Edit Patient Modal -->
@include('partials.midwife.patient.patient_edit')

@endsection

@push('scripts')
{{-- Configuration for patients-index.js --}}
<script>
    window.MIDWIFE_PATIENTS_CONFIG = {
        prenatalRecordUrl: '{{ route("midwife.prenatalrecord.index") }}'
    };
</script>

<script src="{{ asset('js/midwife/midwife.js') }}"></script>
<script src="{{ asset('js/midwife/patients-index.js') }}"></script>
@endpush