...
<link rel="stylesheet" href="{{ asset('css/midwife/prenatalrecord-index.css') }}">
@endpush
...
<div class="space-y-6">
    ...
    <div class="bg-white p-4 rounded-lg shadow-sm border">
        <form method="GET" action="{{ route('midwife.prenatalrecord.index') }}">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="flex space-x-2">
                    ...
                    <a href="{{ route('midwife.prenatalrecord.index') }}" class="flex-1 bg-gray-100 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-200 transition-colors text-center">
                        Clear
                    </a>
                </div>
            </div>
