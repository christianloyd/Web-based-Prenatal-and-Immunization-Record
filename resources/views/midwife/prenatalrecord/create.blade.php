...
<link rel="stylesheet" href="{{ asset('css/midwife/prenatalrecord-create.css') }}">
@endpush
...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div class="flex items-center space-x-3">
            <a href="{{ route('midwife.prenatalrecord.index') }}" class="text-gray-500 hover:text-gray-700">
    ...
    <!-- Form Container -->
    <form action="{{ route('midwife.prenatalrecord.store') }}" method="POST" id="prenatal-form" class="space-y-6">
        @csrf
            ...
            <div class="space-y-4">
                <div class="relative">
                    ...
                    <p class="text-sm text-gray-500 mt-2">
                        ...
                        <a href="{{ route('midwife.patients.index') }}" class="text-blue-600 hover:text-blue-800 underline" target="_blank">
        ...
        <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4 pt-6 border-t bg-white rounded-lg p-6">
            <a href="{{ route('midwife.prenatalrecord.index') }}" class="btn-secondary">
...
<script>
    window.PRENATAL_CREATE_CONFIG = {
        searchUrl: '{{ route("midwife.patients.search") }}'
        @if(old('patient_id'))
...
<script src="{{ asset('js/midwife/prenatalrecord-create.js') }}"></script>
@endpush