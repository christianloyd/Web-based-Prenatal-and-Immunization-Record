...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <nav class="flex items-center space-x-2 text-sm text-gray-600 mb-4">
        <a href="{{ route('midwife.dashboard') }}" class="hover:text-primary">
            <i class="fas fa-home"></i> Home
        </a>
        <span>/</span>
        <a href="{{ route('midwife.prenatalrecord.index') }}" class="hover:text-primary">
            Prenatal Records
        </a>
        <span>/</span>
        <a href="{{ route('midwife.prenatalrecord.show', $prenatal->id) }}" class="hover:text-primary">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('midwife.prenatalrecord.show', $prenatal->id) }}"
    ...
    <!-- Main Form -->
    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
        <form action="{{ route('midwife.prenatalrecord.update', $prenatal->id) }}"
              method="POST"
              class="space-y-6">
            @csrf
            @method('PUT')
