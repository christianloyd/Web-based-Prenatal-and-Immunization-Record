...
<link rel="stylesheet" href="{{ asset('css/midwife/childrecord-index.css') }}">
@endpush
...
<script>
    window.CHILDRECORD_CONFIG = {
        searchRoute: '{{ route("midwife.childrecord.search") }}'
    };
</script>

<script src="{{ asset('js/midwife/midwife.js') }}"></script>
<script src="{{ asset('js/midwife/childrecord-index.js') }}"></script>
@endpush
