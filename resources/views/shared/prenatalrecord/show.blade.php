...
<div class="space-y-2">
    <!-- Back Button -->
    <div class="mb-2">
        <a href="{{ route(auth()->user()->role . '.prenatalrecord.index') }}" class="btn-action btn-view inline-flex items-center">
    ...
    <div class="bg-white rounded shadow-sm border">
        ...
        <div class="px-4 py-3">
            ...
            <div class="flex justify-end space-x-1">
                <a href="{{ route(auth()->user()->role . '.prenatalcheckup.index') }}" class="btn-action btn-success inline-flex items-center">
                    <i class="fas fa-stethoscope mr-1"></i>
                    <span class="hidden sm:inline">Schedule</span>
                </a>
                <a href="{{ route(auth()->user()->role . '.prenatalrecord.edit', $prenatalRecord->id) }}" class="btn-action btn-edit inline-flex items-center">
