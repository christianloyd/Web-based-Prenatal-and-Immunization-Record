...
<div class="space-y-2">
    <!-- Back Button -->
    <div class="mb-2">
        <a href="{{ route(auth()->user()->role . '.childrecord.index') }}" class="btn-action btn-view inline-flex items-center">
    ...
    <div class="bg-white rounded shadow-sm border">
        ...
        <div class="px-4 py-3">
            ...
            <div class="flex justify-end space-x-1">
                <a href="{{ route(auth()->user()->role . '.immunization.index') }}" class="btn-action btn-success inline-flex items-center">
                    <i class="fas fa-syringe mr-1"></i>
                    <span class="hidden sm:inline">Schedule</span>
                </a>
                <a href="{{ route(auth()->user()->role . '.childrecord.edit', $childRecord->id) }}" class="btn-action btn-edit inline-flex items-center">
