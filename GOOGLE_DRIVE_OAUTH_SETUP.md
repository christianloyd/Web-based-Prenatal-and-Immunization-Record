...
5. **Add Authorized redirect URIs:**
   ```
   http://localhost/health-care/public/google/callback
   http://localhost:8000/google/callback
   https://yourdomain.com/health-care/public/google/callback
   https://www.yourdomain.com/health-care/public/google/callback
...
```json
{
  "web": {
    ...
    "redirect_uris": ["http://localhost/health-care/public/google/callback"]
  }
}
```
...
```env
# Leave empty - auto-detects localhost
# GOOGLE_REDIRECT_URI=
```
...
GOOGLE_REDIRECT_URI=https://yourdomain.com/health-care/public/google/callback
```
...
- ✅ Auto-detects `http://localhost/health-care/public/google/callback`
...
- **Solution:** System should auto-refresh, or click "Disconnect" and reconnect
